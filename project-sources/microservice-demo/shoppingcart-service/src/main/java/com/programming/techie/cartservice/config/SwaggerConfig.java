...
public class SwaggerConfig {
			...
			if (servers != null) {
				servers = servers.stream()
						.map(server -> {
							...
							server.setUrl("");
							server.description("ShoppingCart API service");
							return server;
						})
    ...
    public OpenAPI customizeOpenAPI()
    {
        ...
        return new OpenAPI()
          ...
          .info(new Info().title("MSPT ShoppingCart API")
          .description("OpenAPI definition for the MSPT ShoppingCart API endpoints."));
    }
