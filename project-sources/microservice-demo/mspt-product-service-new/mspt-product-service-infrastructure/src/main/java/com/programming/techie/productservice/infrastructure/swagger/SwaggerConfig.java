package com.programming.techie.productservice.infrastructure.swagger;
...
public class SwaggerConfig {
			...
			if (servers != null) {
				servers = servers.stream()
						.map(server -> {
							...
							server.setUrl("");
							server.description("Product API service");
							return server;
						})
    ...
    public OpenAPI customizeOpenAPI()
    {
        ...
        return new OpenAPI()
          ...
          .info(new Info().title("MSPT Product API")
          .description("OpenAPI definition for the MSPT Product API endpoints."));
    }
