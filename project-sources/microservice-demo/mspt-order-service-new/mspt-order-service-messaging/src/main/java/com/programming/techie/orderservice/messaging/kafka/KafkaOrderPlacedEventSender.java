...
import com.programming.techie.common.messaging.kafka.IKafkaMessageBusSender;
...
@Slf4j
class KafkaOrderPlacedEventSender implements IKafkaMessageBusSender<OrderPlacedEvent> {
